      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 3:
            ...
            if (result.data.success) {
              (0, _alerts.showAlert)('success', 'You have been logged out.');
              window.setTimeout(function () {
                location.assign('/');
              }, 1500);
            }
...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1Ijoia2VubWFyZWFkeSIsImEiOiJja25ocDF4M3MwbGtyMnVudHBod28yeWhxIn0.8KcAiE8pYa6OIjEJSNHtZw';
  ...
  locations.forEach(function (loc) {
    ...
    new mapboxgl.Marker({
      element: el,
      anchor: 'bottom'
    }).setLngLat(loc.coordinates).addTo(map); // add popup tp marker
  ...
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(form) {
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            return _context.abrupt("return", _axios.default.patch('http://localhost:3000/api/v1/users/update', form).then(function (result) {
              if (result.data.success) {
                (0, _alerts.showAlert)('success', 'Data updated successfully');
              }
            }).catch(function (err) {
              return (0, _alerts.showAlert)('error', err.response.data.message);
            }));
...
var updateMyPassword = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(currentPassword, newPassword, newPasswordConfirm) {
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            return _context2.abrupt("return", _axios.default.patch("http://localhost:3000/api/v1/users/password", {
              currentPassword: currentPassword,
              newPassword: newPassword,
              newPasswordConfirm: newPasswordConfirm
            }).then(function (result) {
              if (result.data.success) (0, _alerts.showAlert)('success', 'Password updated successfully');
            }).catch(function (err) {
              return (0, _alerts.showAlert)('error', err.response.data.message);
            }));
  ...
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(tourId) {
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            stripe = Stripe('pk_test_51IieIBDo6kRQkwAyGGprtBknfmc4NSRBq8p7GwcpTQsH7fvzMFX0pjP0hWhWfsu1fkkMhrZvgxEXFUeDux96QRGW000olOj1hI'); // get session from the server
          ...
          case 4:
            ...
            console.log(response.data); // create checkout form + credit card:
...
var bookTourBtn = document.getElementById('book-tour'); // Other values=============================================================
// display map===============================================================
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            console.log('form:', _toConsumableArray(form.entries()));
            _context.next = 9;
            return (0, _updateUser.updateMe)(form);
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            _context2.next = 7;
            return (0, _updateUser.updateMyPassword)(currentPassword, newPassword, newPasswordConfirm);
